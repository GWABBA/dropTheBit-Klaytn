...
############################
sudo docker build -f ${DOCKERFILE} --platform=linux/amd64 --tag dtb/$MODULE:${TAG} .
check_error
small_box "docker build done"

############################
sudo docker tag dtb/$MODULE:${TAG} 268788539198.dkr.ecr.ap-northeast-2.amazonaws.com/dtb/$MODULE:${TAG}
check_error
